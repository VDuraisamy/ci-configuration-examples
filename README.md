...
|:---------------------------|:-----------------:|:----------------------------:|:--------------------------:|
[![MATLAB](https://github.com/VDuraisamy/ci-configuration-examples/actions/workflows/ci.yml/badge.svg)](https://github.com/GITHUB_USERNAME/GITHUB_REPO_NAME/actions/workflows/ci.yml)
